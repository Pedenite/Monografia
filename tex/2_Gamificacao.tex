...
A tecnologia da comunicação pode ser aplicada nas salas de aula de forma a dinamizar o processo de ensino. Os tempos atuais mudaram os padrões educacionais, tornando a educação em um sistema voltado para o desenvolvimento de competências e habilidades. Isso pode ajudar os alunos a compreenderem melhor a realidade, consequentemente, os influenciando positivamente no presente e até no futuro \cite{tecnologia-professores}.
